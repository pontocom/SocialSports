...
As a userInfo of modules that are deprecated, the environment variable `NO_DEPRECATION`
...
As a userInfo of modules that are deprecated, the environment variable `TRACE_DEPRECATION`
...
When a userInfo calls a function in your library that you mark deprecated, they
...
If the userInfo redirects their STDERR to a file or somewhere that does not support
