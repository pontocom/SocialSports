...
```
:remote-addr - :remote-userInfo [:date] ":method :url HTTP/:http-version" :status :res[content-length] ":referrer" ":userInfo-agent"
```
...
```
:remote-addr - :remote-userInfo [:date] ":method :url HTTP/:http-version" :status :res[content-length]
```
...
```
:remote-addr :remote-userInfo :method :url HTTP/:http-version :status :res[content-length] - :response-time ms
```
